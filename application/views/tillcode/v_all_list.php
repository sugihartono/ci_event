                            ...
                            <table class="table table-bordered table-striped table-condensed" id="datatable">
								...
								<tbody>
								    ...
								    <tr>
										...
										<td><?php echo $r->disc3; ?></td>
										<td><?php echo ($r->is_sp == 1 ? "Y" : "N"); ?></td>
										<td class="al-center">
											<a id="a-<?php echo $r->tillcode; ?>" data-id='<?php echo $r->tillcode; ?>'
												data-disc1='<?php echo $r->disc1; ?>'
												data-disc2='<?php echo $r->disc2; ?>'
												data-disc3='<?php echo $r->disc3; ?>'
												data-issp='<?php echo $r->is_sp; ?>'
												data-toggle='modal'
